"""Repository-level safeguards for the installable integration."""
...
def test_integration_contains_no_state_changing_transport_calls() -> None:
    python_source = "\n".join(
...
def test_public_integration_contains_only_selected_source_ids() -> None:
    source = (INTEGRATION / "sensor.py").read_text(encoding="utf-8")
